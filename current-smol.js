...
window[CHANNEL.name].sequenceList = {
	'event-ext': {
		active: 1,
		rank: -1,
		url: "https://rawcdn.githack.com/gimmic234/cytube_backup/4bcb2436b8b6f53f61c3b5bd91c3e5ede438dc08/current-ext.js",
		callback: true
	},
	'layout': {
		active: 1,
		rank: -1,
		url: "https://rawcdn.githack.com/gimmic234/cytube_backup/73bb5f74ce7c4f21a760241434416f260b94a43e/module/channelbase-mod.js",
		callback: true
	},
	'settings': {
		active: 1,
